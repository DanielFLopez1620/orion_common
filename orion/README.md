...
- [🖼️ Meet ORION](#️-meet-orion)

---

## 📦 Core Packages

This meta-package ensures all dependencies are available:

- **[orion_description](/orion_description/README.md)** — URDF/Xacro robot model, mesh files, and description launch files
...
1. **Installation:** Follow the main [README](/README.md) for setup instructions.
2. **Hardware:** Check the [Wiki](https://github.com/DanielFLopez1620/orion_common/wiki) for robot construction and schematics.
3. **Examples:** See [orion_utils_py](/orion_utils_py/README.md) for demo scripts.

---

## 📖 Documentation

- **[Main README](/README.md)** — Full installation and troubleshooting guide
- **[CONTRIBUTING.md](/CONTRIBUTING.md)** — Code standards, branch naming, and PR guidelines
