#!/usr/bin/env python3
"""Execute a scripted theater performance sequence for ORION demos."""
...
class RobotPerformer(Node):
    """Execute a sequence of movements and broadcast messages for a robot performance."""
    ...
    def create_twist_stamped(self, linear_x, angular_z):
        """Create a populated TwistStamped message with the given velocities.
        ...
        Returns:
            geometry_msgs.msg.TwistStamped populated with the given values.
        """
        twist = TwistStamped()
...
def main(args=None):
    """Run the RobotPerformer sequence and shut down."""
